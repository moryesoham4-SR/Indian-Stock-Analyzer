...
if not st.session_state.booted:
    ...
    boot.markdown(
        ...
        @keyframes glowPulse {
            from { text-shadow: 0 0 10px rgba(0,255,80,0.4); }
            to   { text-shadow: 0 0 30px rgba(0,255,80,0.9), 0 0 60px rgba(0,255,80,0.4); }
        }
        ...
        <div class="boot-screen">
            ...
            <div class="boot-lines">
                <div class="boot-line info">[INIT] &nbsp; Booting NSE Terminal System...</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;Market data engine loaded</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;Yahoo Finance connector ready</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;Technical indicators module loaded</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;AI prediction engine initialized</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;Database connection established</div>
                <div class="boot-line warn">[WARN] &nbsp;Live ticker running in static mode</div>
                <div class="boot-line ok">  [OK] &nbsp; &nbsp;All systems ready</div>
            </div>

            <div class="boot-bar-bg">
                <div class="boot-bar-fill"></div>
            </div>

            <div class="boot-status">INITIALIZING... PLEASE WAIT</div>
        </div>
        """,
        unsafe_allow_html=True
    )
