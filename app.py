...
st.markdown(
    ...
    <div class="ticker-wrap">
        <div class="ticker-track">
            <span style="color:#22C55E;">📈 Indian Stock Market Analyzer</span>
            &nbsp;|&nbsp;
            <span style="color:#FBBF24;">⚡ Live Data via Yahoo Finance</span>
            &nbsp;|&nbsp;
            <span style="color:#60A5FA;">🔍 AI Powered Predictions</span>
            &nbsp;|&nbsp;
            <span style="color:#A78BFA;">📊 Technical Analysis</span>
            &nbsp;|&nbsp;
            <span style="color:#F97316;">💼 Portfolio Tracker</span>
            &nbsp;|&nbsp;
            <span style="color:#22C55E;">🌐 Market Dashboard</span>
            &nbsp;|&nbsp;
            <span style="color:#FBBF24;">⭐ Watchlist</span>
            &nbsp;|&nbsp;
            <span style="color:#60A5FA;">📰 Stock News</span>
            &nbsp;|&nbsp;
            <span style="color:#22C55E;">📈 Indian Stock Market Analyzer</span>
            &nbsp;|&nbsp;
            <span style="color:#FBBF24;">⚡ Live Data via Yahoo Finance</span>
    ...
    if run_screen:
        ...
        if not results:
            ...
            if df_filtered.empty:
                ...
                styled = df_filtered.drop(columns=["Cap Type"]).style.map(
